  ...
  return (
    <Card className="w-full max-w-md">
      <CardHeader className="text-center">
        ...
        <CardDescription>
          Estudiantes UPC usen su email <span className="font-medium">@unicesar.edu.co</span> para poder subir proyectos
        </CardDescription>
      </CardHeader>
      ...
      <CardContent className="space-y-4">
        ...
        <form action={action} className="space-y-3">
          ...
          <div className="space-y-1">
            ...
            <Input id="email" name="email" type="email" placeholder="tu@unicesar.edu.co" required autoComplete="email" />
          </div>
          <div className="space-y-1">
